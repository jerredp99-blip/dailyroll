...
export type { FeedModalProps, FeedModalProps as CommunityFeedModalProps };

export function CommunityFeedModal({
  isOpen,
  onClose,
  currentUserEmail,
  currentUserName,
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="community-feed-modal-title"
    >
      <div
      ...
      >
        <div className="flex items-center justify-between px-4 py-3 border-b border-zinc-800/80 bg-zinc-900/60 shrink-0">
          <div className="flex items-center gap-2">
            ...
            <h3 id="community-feed-modal-title" className="text-sm font-black text-white tracking-wide">
              Community Feed
            </h3>
          </div>
          <button
